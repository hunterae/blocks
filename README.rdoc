...
and then elsewhere, you call:
  <%= blocks.use :my_block %>

== Passing parameters to blocks

If you want to do something slightly more complex than the above example, you can pass parameters to your defined block:

  <% blocks.define :my_block do |options| %>
    The user of this block passed in "<%= options[:my_parameter] %>" as :my_parameter.
  <% end %>

This block may now be used as:
...
If you do not pass in the anticipated parameters:
  <%= blocks.use :my_block %>
